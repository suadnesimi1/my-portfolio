    ...
    <div className={darkMode ? "dark bg-gray-950 text-white" : "bg-gray-100 text-gray-900"}>
      <div className="min-h-screen px-6 py-10 max-w-6xl mx-auto font-sans smooth-scroll">
        ...
        <motion.h1
          ...
          className="whitespace-nowrap text-4xl font-extrabold bg-gradient-to-r from-[#3B82F6] via-[#06B6D4] to-[#22C55E] bg-clip-text text-transparent drop-shadow-lg hover:drop-shadow-[0_8px_24px_rgba(6,182,212,0.6)] transition duration-300 cursor-pointer"
        >
          Suad Nesimi
        </motion.h1>
            ...
            {/* Education */}
            <motion.section
              className={`rounded-2xl p-6 border transition duration-300 shadow-xl hover:shadow-[0_15px_40px_rgba(59,130,246,0.3)] max-w-xs cursor-pointer ${
                darkMode
            ...
            >
              ...
              <ul className={`text-sm leading-relaxed space-y-1 ${darkMode ? "text-gray-300" : "text-gray-700"}`}>
                <li>
                  <strong>Albanian</strong> <span className="text-xs font-normal">– Native</span>
                </li>
                <li>
                  <strong>English</strong> <span className="text-xs font-normal">– Professional Proficiency</span>
                </li>
                <li>
                  <strong>Turkish</strong> <span className="text-xs font-normal">– Professional Proficiency</span>
                </li>
                <li>
                  <strong>Macedonian</strong> <span className="text-xs font-normal">– Elementary Proficiency</span>
                </li>
              </ul>
            </motion.section>
